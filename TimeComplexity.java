...
public class TimeComplexity extends inputParser {
	...
	public static double processLineForLoop(String wordParse, int currentline) throws FileNotFoundException{
	...
	public static int countLinesInLoop(int currentline) throws FileNotFoundException {
			...
			Scanner input = new Scanner(new File("input.java")); //input file
 	...
 	public static int processIf(String wordParse, int currentline) throws FileNotFoundException{
 			...
 			counter += (int) (endTime-startTime);
 			System.out.println("Total response time for if statement: "+counter);
 			return ifComplexity;
